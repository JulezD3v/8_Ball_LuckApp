...
void main() {
  runApp(const MaterialApp(
    home: Magic8BallPage(), debugShowCheckedModeBanner:false),
    );
      ...
      child: Center(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            titleTextStyle: GoogleFonts.lato(fontSize: 20, fontWeight: FontWeight.w600, color: Colors.black),
            backgroundColor: Colors.white,
        ...
        //Button
                OutlinedButton(onPressed: (){
                  //Shake(child: BallArea(), trigger:true ); ==> widget is being created 
                  //context.read<EightBallBloc>().add(BallArea()); tomorrows problem
                },
